label sc_002_elder_girl_conversation:
    ...
    elder "Sobre todo si no salen de nuestra imaginación."
    ...
    "{i}El sabio dejó de caminar y se volvió hacia ella para mirarla. Los ojos de Éstel se movían inquietos como si ahora cientos de pensamientos se arremolinaran en su cabeza.{/i}"
    ...
    "{i}Él quedó un rato pensativo, mirando hacia el lugar por que el que ella se había marchado y, tras un tiempo de meditación en silencio, dijo:{/i}"
