label sc_001_story_telling:
    ...
    nvl_narrator "Sus cuerpos habían perdido el color y eran de un gris oscuro como la más profunda de las tormentas y sus ojos rojizos como atrapados en ira"
    nvl_narrator "Como si estuvieran condenados a cargar con el dolor del bosque por el resto de la eternidad"
    nvl_narrator "Nada ni nadie que estuviera fuera de aquel lugar se atrevía a entrar"
    nvl_narrator "Sus árboles sin hojas, como en un eterno invierno, y de oscura corteza, como quemadas por el fuego, entrecruzaban sus ramas..."
    ...
    nvl_narrator "Así, apiadándose del agónico lugar, se internó en su silenciosa oscuridad"
    nvl_narrator "A pesar de estar poniendo en peligro su vida con cada paso que daba, ella siguió avanzando"
    nvl_narrator "Porque su misión era más grande que sus miedos"
    nvl_narrator "Y estaba decidida a hacer cuanto pudiera por aquel lugar que tanto había sufrido"
    nvl_narrator "A pesar de que el bosque reaccionó contra ella, su presencia empezó a cambiarlo todo"
    nvl_narrator "Usando su don, la maga lanzaba sus palabras al aire y éstas resonaban entre los árboles llegando hasta quien pudiera oirlas"
    nvl_narrator "Cuentan que entonces una pequeña luz empezó a surgir entre la penumbra y con ella los colores que se habían perdido"
    nvl_narrator "La hierba comenzó de nuevo a crecer, las ramas se vistieron con hojas y los árboles volvieron a dejarle paso al sol"
    nvl_narrator "Las criaturas, que acechaban y ponían en peligro la vida de quien quería ser su salvadora,"
    ...
    nvl_narrator "La criatura, con más ira y crueldad, si cabe, que todas las demás juntas"
    nvl_narrator "Atacó a nuestra valiente maga dejándola sin vida"
